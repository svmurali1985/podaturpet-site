...
try{
 ...
 test('buyer can reach a dedicated wholesale enquiry from the homepage',()=>assert(deep.d.querySelector('.rev-wholesale a').href.includes('wholesale-lungi-enquiry.html')));
